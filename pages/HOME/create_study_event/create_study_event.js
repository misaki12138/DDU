Page({
  ...
  start_event: function () {
    ...
    db.collection("study_comm").where({
    }).get({
      success: res => {
        ...
        wx.navigateTo({
          url: '../library/library?event=' + tevent + '&time=' + ttime + '&type=0'
        })
      },
      fail: err => {
        wx.showToast({
  ...
  custom_event: function () {
    wx.navigateTo({
      url: '../create_custom_study_event/create_custom_study_event',
    })
  },
